...
const leadershipData = [
    {
        ...
        date: "2023 - 2024",
        description: "Organized and led multiple AI/ML-focused technical events, workshops, and webinars, engaging students across all academic years. Spearheaded AI/ML Odyssey, ML101, and Computer Vision: Pixels to Patterns, introducing industry trends and practical ML roadmaps. Conducted hands-on deep learning and Python-to-ML workshops for first- and third-year students. Organized HackQuinox 2025, a nationwide hackathon in collaboration with CSI FCRIT. Also curated large-scale technical theme-based events.",
        highlights: ["200+ Members", "WebRush'24", "HackQuinox 2025", "Mentored 500+"],
